...
// const tickingSound = '/sounds/spin-wheel-sound.mp3';
import { ISpinWheelProps } from '@/types/types';
// const ticTicSound: HTMLAudioElement | null =  new Audio("/sounds/ball.wav") 
// const ticTicSound = new Audio("/sounds/ball.wav");
const SpinWheel: React.FC<ISpinWheelProps> = ({
  ...
  return (
    <div id='wheel' className='flex justify-center items-center flex-col'>
      <canvas
        id='canvas'
        width={size * 2}
        height={size * 2}
